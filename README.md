...
Bu projedeki makale say�lar�n�n ve tablolar�n�n �retilebilirli�i �effaf ve denetlenebilir bir s�re�le g�vence alt�na al�nm��t�r. 
Sistemde kullan�lan say�lar ve kar��l�k gelen betikler ile ��kt�lar a�a��da listelenmi�tir:

| Makaledeki Tablo/Say� | �reten Script | ��kt� Dosyas� | Manifest |
|---|---|---|---|
| FACTurk (D�� Benchmark) F1 ve Accuracy | scripts/evaluate_facturk_pipeline.py | 
esults/facturk_full_v2/metrics.json | 
esults/facturk_full_v2/run_manifest.json |
| U�tan Uca Do�ruluk (B3) | scripts/evaluate_b2_pipeline.py | 
esults/e2e_v1/metrics.json | 
esults/e2e_v1/run_manifest.json |
| Ablasyon �al��mas� (B4) | scripts/run_ablations.py | 
esults/ablation_v1/ alt�ndaki dizinler | Her dizin i�indeki 
un_manifest.json |
| Gecikme �l��mleri (B6) | scripts/benchmark_latency.py | 
esults/latency_v1/summary.json | 
esults/latency_v1/manifest.json |
| 500 �ddia Annotasyon Uyum (B1) | scripts/audit_evaluation_assets.py | 
esults/iaa_v1/iaa_report.json | data/gold_500/annotation_manifest.json |

### S�rekli Entegrasyon (CI) Kurallar�
- Manifest'i ve �retilebilir script'i bulunmayan hi�bir say� makaleye girmeyecektir.
- GitHub Actions CI �zerinde scripts/audit_evaluation_assets.py --strict her push'ta ko�ularak insan-etiketli veri setinin b�t�nl��� ve ayr�kl��� korunmaktad�r. 
- *�nemli Not:* Se�enek-2 gere�i K-5 encoder kar��la�t�rmas� nicel tablolardan (Tablo 3) ��kar�lm�� olup niteliksel a��klamayla makaleye dahil edilecektir. K-6, K-8 ve K-9 katmanlar� sadece *bilgilendirme (advisory)* niteli�indedir ve do�rudan (f�zyon olmadan) karar motorunun otomatik F1 ��kt�s�na girmemektedir.
